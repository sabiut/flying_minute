...
class minutesForm(forms.ModelForm):
    class Meta:
        model = fly_minute
        fields = 'Agenda','mode_of_meeting', 'date', 'Time', 'minute_prepared_by', 'location', 'authorize_by', 'item', 'owner', 'recommendations', 'notes', 'issues', 'resolutions', 'resolution_Owner', 'due_date', 'Action',
